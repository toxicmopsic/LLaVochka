...
def parse_args():
    ...
    parser.add_argument('--model_name', help='', default='llava.lora')
...
For example:
For the question 'How challenging is the game being played?', answer with 'The game being played is secondary.' or 'The game being played is simple.'
For the question 'How risky is it to practice gymnastics indoors?', answer with 'Practicing gymnastics indoors can be dangerous if safety mats are not used.' or 'It is somewhat risky to practice gymnastics indoors because of hard surfaces.'
For the question 'What did the girl experience after finishing her dessert?', answer with 'The girl felt a sugar rush after finishing her dessert.' or 'The girl felt satisfied after finishing her dessert.'
For the question 'Is the runner wearing a jacket?', answer with 'The runner is wearing a lightweight shirt instead of a jacket.' or 'The runner is not wearing a jacket, but has on a tank top.'
