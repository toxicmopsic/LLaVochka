...
def run_inference(args):
    ...
    """
    data_list = {
        "count": ("json/4_count.json", f"{args.data_dir}/video/4_count", "video"),
        "ego": ("json/3_ego.json", f"{args.data_dir}/video/3_ego", "video"),
        "needle": ("json/2_needle.json", f"{args.data_dir}/video/2_needle", "video"),
        "order": ("json/5_order.json", f"{args.data_dir}/video/5_order", "video"),
        "plotQA": ("json/1_plotQA.json", f"{args.data_dir}/video/1_plotQA", "video"),
        "anomaly_reco": ("json/6_anomaly_reco.json", f"{args.data_dir}/video/6_anomaly_reco", "video"),
        "topic_reasoning": ("json/7_topic_reasoning.json", f"{args.data_dir}/video/7_topic_reasoning", "video")
    }
