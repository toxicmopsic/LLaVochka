...
pred_path="${exp_dir}/MSVD_Zero_Shot_QA/${CKPT_NAME}/merge.jsonl"
output_dir="${exp_dir}/MSVD_Zero_Shot_QA/${CKPT_NAME}/gpt-3.5-turbo"
output_json="${exp_dir}/MSVD_Zero_Shot_QA/${CKPT_NAME}/gpt-3.5-turbo_results.json"
